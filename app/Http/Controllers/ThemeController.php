    ...
    protected function getStore(Request $request, $storeSlug = null)
    {
        ...
        if ($request && $request->attributes->has('resolved_store')) {
            ...
            return [
                ...
                'enable_custom_domain' => (bool)$store->enable_custom_domain,
                'custom_subdomain' => $store->custom_subdomain,
                'enable_custom_subdomain' => (bool)$store->enable_custom_subdomain,
                'theme' => $store->theme,
                'slug' => $store->slug,
                'custom_css' => $configuration['custom_css'] ?: '',
                'custom_javascript' => $configuration['custom_javascript'] ?: '',
                'custom_head_code' => $configuration['custom_head_code'] ?: '',
                'facebook_pixel' => $configuration['facebook_pixel'] ?: '',
                'facebook_capi_token' => $configuration['facebook_capi_token'] ?? '',
