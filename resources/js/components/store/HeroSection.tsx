...
export default function HeroSection({
  title = storeTheme.homepage.heroSection.title,
  subtitle = storeTheme.homepage.heroSection.subtitle,
  buttonText = storeTheme.homepage.heroSection.buttonText,
  buttonLink = storeTheme.homepage.heroSection.buttonLink,
  image = storeTheme.homepage.heroSection.image,
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pr-12 mb-10 md:mb-0">
            ...
            >
              <a 
                href={buttonLink} 
                className="group bg-primary text-white px-8 py-3 rounded-full font-medium hover:bg-blue-700 transition-all duration-300 inline-flex items-center"
              >
                {buttonText}
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <div>
                  <span className="text-sm font-medium block">Secure Checkout</span>
