        ...
        {enhancedCategories.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {enhancedCategories.slice(0, 4).map((category, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-storePrimary-50 to-pink-50 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  {/* Content */}
                  <div className="p-6">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-storePrimary-600 transition-colors duration-300">
                      {category.name}
                    </h3>
                    <p className="text-gray-600 text-sm mb-4">
                      {category.description}
                    </p>
                    <div className="flex items-center text-storePrimary-600 font-medium text-sm">
