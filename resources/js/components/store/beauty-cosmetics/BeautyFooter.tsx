    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              {logo ? (
                ...
                <h3 className="text-2xl font-light text-storePrimary-400 mb-4">{storeName}</h3>
              )}
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.url || '#'}
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-storePrimary-400 hover:bg-gray-700 transition-all duration-300"
          ...
          {/* Customer Care */}
          <div>
            <h4 className="text-lg font-semibold mb-6 text-storePrimary-400">
            ...
            <ul className="space-y-3">
              {(footerContent?.menu1?.links?.value || footerContent?.menu1?.links || [
                ...
                <li key={index}>
                  <a 
                    href={link.href}
                    className="text-gray-300 hover:text-storePrimary-400 transition-colors duration-300"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-6 text-storePrimary-400">Get in Touch</h4>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-storePrimary-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-storePrimary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
