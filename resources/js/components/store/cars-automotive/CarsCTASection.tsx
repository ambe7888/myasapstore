...
export default function CarsCTASection({ content, ctaBoxes }: CarsCTASectionProps) {
  ...
  return (
    <section className="py-20 bg-black text-white relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-0 w-32 h-32 border-l-4 border-t-4 border-storePrimary-600 opacity-20"></div>
      <div className="absolute bottom-0 right-0 w-32 h-32 border-r-4 border-b-4 border-storePrimary-600 opacity-20"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="inline-block bg-storePrimary-600 text-white px-6 py-2 text-sm font-bold tracking-widest uppercase mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {boxes.map((box, index) => {
            ...
            return (
              <div
                key={index}
                className="group text-center p-8 bg-gray-900 hover:bg-storePrimary-600 border-2 border-gray-800 hover:border-storePrimary-600 transition-all duration-300 cursor-pointer"
              >
                <div className="mb-6">
                  <div className="w-20 h-20 bg-storePrimary-600 group-hover:bg-white mx-auto flex items-center justify-center transition-colors duration-300">
                    <IconComponent className="h-10 w-10 text-white group-hover:text-storePrimary-600" />
                  </div>
                </div>
        ...
        {/* Bottom CTA */}
        <div className="bg-storePrimary-600 p-12 text-center relative">
          ...
          <p className="text-xl text-storePrimary-100 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a
              ...
              className="inline-flex items-center px-10 py-4 bg-white text-storePrimary-600 hover:bg-gray-900 hover:text-white font-bold tracking-wider uppercase transition-colors"
            >
