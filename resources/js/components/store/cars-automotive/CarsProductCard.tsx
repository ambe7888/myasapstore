            ...
            {store?.show_add_to_cart_button !== false && (
              <div className="flex-1 min-w-0">
                <AddToCartButton
                  product={product}
                  store={store}
                  className="w-full h-9 sm:h-10 text-[11px] sm:text-xs font-semibold text-white flex items-center justify-center px-1 shadow-sm"
                />
              </div>
            )}
            <div className="flex-1 min-w-0">
              <BuyNowButton 
                product={product} 
                store={store} 
                className="w-full h-9 sm:h-10 text-white font-semibold flex items-center justify-center text-[11px] sm:text-xs shadow-sm px-1" 
              />
            </div>
          </div>
        </div>
