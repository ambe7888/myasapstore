  ...
  return (
    <footer className="bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-storePrimary-500/5 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              {logo ? (
                ...
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-storePrimary-600 rounded-lg flex items-center justify-center mr-3">
            ...
            <p className="text-storePrimary-200 mb-6 leading-relaxed">
            ...
            <div className="flex space-x-4">
              {(content?.social_links?.value || content?.social_links || [
                ...
                <a
                  ...
                  className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center text-storePrimary-300 hover:text-white hover:bg-storePrimary-600 transition-all duration-300"
            ...
            <ul className="space-y-3">
              {(content?.menu1?.links?.value || content?.menu1?.links || [
                ...
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-storePrimary-200 hover:text-white transition-colors duration-300 flex items-center group"
                  >
                    <span>{link.name}</span>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <svg className="w-5 h-5 text-storePrimary-400 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <p className="text-storePrimary-200 text-sm leading-relaxed">
                  {content?.contact?.address?.value || content?.contact?.address || '456 Tech Avenue, Innovation District, CA 94105'}
                </p>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-storePrimary-400 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <p className="text-storePrimary-200 text-sm">
