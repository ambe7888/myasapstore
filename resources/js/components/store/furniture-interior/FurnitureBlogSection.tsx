      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <div className="inline-flex items-center gap-3 bg-storePrimary-100 border-2 border-storePrimary-300 px-6 py-3 rounded-full mb-6 hover:scale-105 transition-transform duration-300">
            ...
            <span className="text-sm font-bold text-storePrimary-800 tracking-wider uppercase">Design Insights</span>
          </div>
        ...
        {posts.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {posts.slice(0, 3).map((post) => (
              <article key={post.id} className="group relative bg-white rounded-3xl shadow-lg shadow-storePrimary-200/30 hover:shadow-2xl hover:shadow-storePrimary-300/40 transition-all duration-500 overflow-hidden border border-storePrimary-100 hover:border-storePrimary-200 transform hover:-translate-y-3">
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute inset-0 border-4 border-storePrimary-800/20 rounded-lg m-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  
                  {/* Category badge on image */}
                  {post.category && (
                    <div className="absolute top-4 right-4 bg-storePrimary-800 text-white px-3 py-1 text-xs font-bold rounded-lg shadow-md">
                      {post.category.name}
                    </div>
                  )}
                </div>
                ...
                {/* Content */}
                <div className="p-6 bg-gradient-to-b from-white to-storePrimary-50/30">
                  {/* Date */}
                  <div className="flex items-center gap-2 mb-3">
                    <svg className="w-4 h-4 text-storePrimary-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                    </svg>
                    <span className="text-storePrimary-700 text-sm font-medium">
                  ...
                  <Link
                    href={generateStoreUrl('store.blog.show', store,  { slug: post.slug })}
                    className="inline-flex items-center gap-2 bg-storePrimary-100 hover:bg-storePrimary-200 text-storePrimary-800 font-bold text-sm px-4 py-2 rounded-xl transition-all duration-300 group/link shadow-md hover:shadow-lg"
                  >
                    <span>Read More</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <article key={index} className="group relative bg-white rounded-3xl shadow-lg shadow-storePrimary-200/30 hover:shadow-2xl hover:shadow-storePrimary-300/40 transition-all duration-500 overflow-hidden border border-storePrimary-100 hover:border-storePrimary-200 transform hover:-translate-y-3">
                <div className="relative aspect-[4/3] bg-gradient-to-br from-storePrimary-100 to-yellow-100 flex items-center justify-center">
                  <div className="text-center">
                    <svg className="w-16 h-16 text-storePrimary-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-storePrimary-700 text-sm font-semibold">Design Article</p>
                  </div>
                ...
                <div className="p-6 bg-gradient-to-b from-white to-storePrimary-50/30">
                  ...
                  <div className="inline-flex items-center gap-2 bg-storePrimary-100 hover:bg-storePrimary-200 text-storePrimary-800 font-bold text-sm px-4 py-2 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg">
                    <span>Read More</span>
