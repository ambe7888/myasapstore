    ...
    <section className="py-20 lg:py-24 bg-stone-50 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        {content?.stats !== null && content?.stats?.show_section !== false && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 mt-20 pt-16 border-t-2 border-storePrimary-200">
            {(content?.stats?.value || content?.stats || [
              ...
              <div key={index} className="text-center group">
                <div className="text-3xl lg:text-4xl font-bold text-slate-900 mb-3 group-hover:text-storePrimary-800 transition-colors duration-300">{stat.number}</div>
