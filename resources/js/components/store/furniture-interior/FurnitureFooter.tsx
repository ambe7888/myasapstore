              ...
              <div className="flex space-x-4">
                {(content?.social_links || []).map((social, index) => (
                  <a
                    ...
                    className="w-10 h-10 bg-yellow-700 rounded-full flex items-center justify-center text-yellow-200 hover:text-white hover:bg-storePrimary-600 transition-all duration-300"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-storePrimary-500 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-storePrimary-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
