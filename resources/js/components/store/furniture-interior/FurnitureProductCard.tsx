    ...
    <div className="group bg-white rounded-3xl shadow-lg shadow-amber-200/30 hover:shadow-2xl hover:shadow-amber-300/40 transition-all duration-500 overflow-hidden border border-amber-100 hover:border-amber-200 transform hover:-translate-y-2">
      ...
      <div className="p-5 bg-white">
        ...
        <div className="flex gap-1.5 sm:gap-2 w-full mt-3">
          {store?.show_add_to_cart_button !== false && (
            <div className="flex-1 min-w-0">
              <AddToCartButton
                product={product}
                store={store}
                className="w-full h-9 sm:h-10 rounded-2xl text-[11px] sm:text-xs font-semibold text-white flex items-center justify-center px-1 shadow-sm"
              />
            </div>
          )}
          <div className="flex-1 min-w-0">
            <BuyNowButton 
              product={product} 
              store={store} 
              className="w-full h-9 sm:h-10 text-white font-semibold rounded-2xl flex items-center justify-center text-[11px] sm:text-xs shadow-sm px-1" 
            />
          </div>
        </div>
      </div>
