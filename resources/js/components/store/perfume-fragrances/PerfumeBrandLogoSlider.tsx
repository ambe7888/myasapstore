...
export default function PerfumeBrandLogoSlider({ content }: PerfumeBrandLogoSliderProps) {
  ...
  return (
    <section className="py-16 bg-white border-t border-b border-storePrimary-100">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="mx-4">
              <svg className="w-6 h-6 text-storePrimary-800" fill="currentColor" viewBox="0 0 20 20">
          ...
          <h2 className="text-2xl font-light text-storePrimary-800 mb-4">
        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll-infinite">
            {duplicatedLogos.map((logo, index) => (
              ...
              >
                <div className="relative w-full h-full bg-stone-50 rounded-xl border border-storePrimary-100 flex items-center justify-center hover:border-storePrimary-200 hover:bg-white transition-all duration-300 group-hover:shadow-lg">
                  <img
        ...
        {(content?.bottom_title || content?.bottom_description || content?.bottom_button_text) && (
          <div className="text-center mt-12 p-8 bg-storePrimary-50 rounded-2xl">
            <h3 className="text-xl font-medium text-storePrimary-800 mb-3">
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-3 bg-storePrimary-800 text-white rounded-full font-medium hover:bg-storePrimary-900 transition-colors duration-300"
            >
