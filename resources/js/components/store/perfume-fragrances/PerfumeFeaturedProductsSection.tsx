    ...
    <section className="py-20 bg-stone-50">
      <div className="container mx-auto px-4">
        ...
        <div className="relative mt-20">
          <div className="absolute left-1/4 top-0 w-32 h-32 bg-storePrimary-100/30 rounded-full blur-3xl"></div>
          ...
          <div className="text-center relative z-10">
            <a
              ...
              className="inline-flex items-center px-8 py-4 bg-white border-2 border-storePrimary-200 rounded-full hover:border-storePrimary-300 transition-colors duration-300 group"
            >
              <span className="text-storePrimary-800 font-medium mr-3">Discover More Fragrances</span>
              <svg className="w-5 h-5 text-storePrimary-800 group-hover:translate-x-1 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
