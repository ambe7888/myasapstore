    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-6 py-3 bg-storePrimary-100 rounded-full mb-8">
            ...
            <span className="text-storePrimary-800 font-medium text-sm">Trending Now</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 bg-stone-50 rounded-2xl">
              <div className="w-16 h-16 bg-storePrimary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-storePrimary-800" fill="currentColor" viewBox="0 0 20 20">
        ...
        {products.length > 0 && (
          <div className="text-center mb-16">
            <a
              ...
              className="inline-flex items-center px-8 py-4 bg-storePrimary-800 hover:bg-storePrimary-900 text-white font-medium rounded-full transition-colors duration-300 group"
            >
        ...
        {designProcess && (
          <div className="bg-gradient-to-r from-storePrimary-50 to-stone-50 rounded-3xl p-12 relative overflow-hidden">
            {/* Background Decorations */}
            <div className="absolute top-0 right-0 w-40 h-40 bg-storePrimary-200/20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-amber-200/20 rounded-full blur-2xl"></div>
            
            <div className="relative z-10">
              <div className="text-center mb-12">
                <h3 className="text-3xl font-light text-storePrimary-800 mb-4">
                ...
                {(designProcess?.steps || [
                  ...
                  <div key={index} className="text-center">
                    <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                      <svg className="w-10 h-10 text-storePrimary-800" fill="currentColor" viewBox="0 0 20 20">
                        {step.icon === 'sparkles' && (
