...
function BabyKidsCartContent({
  ...
  return (
      ...
      >
            ...
            {items.length > 0 ? (
                    ...
                    {items.map((item) => {
                      ...
                      return (
                        <div key={item.id} className="group relative">
                          ...
                          <div className="absolute top-4 left-4 right-0 bottom-0 bg-storePrimary-200 rounded-3xl opacity-30"></div>
                          <div className="relative bg-white rounded-3xl shadow-xl border-4 border-storePrimary-400 overflow-hidden hover:shadow-2xl transition-all duration-300">
                            <div className="flex flex-col md:flex-row h-full">
                              ...
                              <div className="flex-1 p-6">
                                ...
                                {/* Title */}
                                <a href={generateStoreUrl('store.product', store, {  id: item.id })}>
                                  <h3 className="text-lg font-bold text-gray-800 mb-3 group-hover:text-storePrimary-600 transition-colors duration-300 line-clamp-2">
                                    {item.name}
                                  </h3>
                                </a>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                  ...
                                  <div className="flex items-center space-x-3">
                                    <button
                                      ...
                                      className="w-8 h-8 bg-storePrimary-100 text-storePrimary-500 rounded-full font-bold hover:bg-storePrimary-200 transition-colors"
                                    >
                                      -
                                    </button>
                                ...
                                {/* Subtotal */}
                                <div className="mt-4 pt-4 border-t border-storePrimary-200">
                ...
                <div className="relative">
                  <div className="relative bg-white rounded-3xl shadow-xl border-4 border-blue-400 p-8 sticky top-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="border-t border-storePrimary-200 pt-4 mt-4">
                        <div className="flex justify-between">
                          <span className="text-xl font-bold">Total</span>
                          <span className="text-xl font-bold text-storePrimary-500">{formatCurrency(dynamicSummary.total, storeSettings, currencies)}</span>
                        </div>
                      </div>
                      ...
                      <div className="mt-6">
                        <form onSubmit={handleApplyCoupon} className="space-y-3">
                          <input
                            ...
                            className="w-full px-4 py-3 border-2 border-storePrimary-300 rounded-2xl focus:outline-none focus:border-storePrimary-500 transition-colors"
                          ...
                          <button 
                            ...
                            className={`w-full py-3 rounded-2xl font-bold transition-colors ${
                              couponApplied 
                                ...
                                : 'bg-storePrimary-500 hover:bg-storePrimary-600 text-white'
                            }`}
                          >
                      ...
                      <div className="mt-8">
                        <a
                          ...
                          className="w-full bg-storePrimary-500 text-white py-4 rounded-2xl font-bold text-lg hover:bg-storePrimary-600 transition-all duration-300 shadow-lg flex items-center justify-center space-x-2"
                        >
              ...
              <div className="text-center py-16">
                <div className="relative inline-block">
                  <div className="absolute top-3 left-3 right-0 bottom-0 bg-storePrimary-200 rounded-3xl opacity-30"></div>
        ...
        {/* Continue Shopping */}
        {items.length > 0 && (
          <div className="bg-storePrimary-50 py-12">
            <div className="container mx-auto px-6 lg:px-12">
              <div className="text-center">
                <a
                  href={generateStoreUrl('store.products', store)}
