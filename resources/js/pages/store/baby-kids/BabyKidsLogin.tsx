                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link
                        ...
                        className="text-sm text-storePrimary-500 hover:text-storePrimary-600 font-bold transition-colors duration-300"
                      >
                        Forgot password?
                      </Link>
                    </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-5 w-5 text-storePrimary-500 focus:ring-storePrimary-400 border-2 border-storePrimary-300 rounded-lg"
                    />
