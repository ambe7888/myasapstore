            ...
            <div className="max-w-6xl mx-auto">
              {orders.length === 0 ? (
                <div className="bg-white rounded-2xl shadow-lg p-16 text-center">
                  <div className="w-32 h-32 bg-storePrimary-100 rounded-full flex items-center justify-center mx-auto mb-8">
                    <ShoppingBag className="h-16 w-16 text-storePrimary-500" />
                  </div>
                  ...
                  <Link
                    ...
                    className="bg-storePrimary-500 text-white px-10 py-4 rounded-xl font-semibold text-lg hover:bg-storePrimary-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                    Explore Products
                  </Link>
                </div>
                ...
                <div className="space-y-8">
                  {orders.map((order) => (
                    <div key={order.id} className="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-storePrimary-100 hover:border-storePrimary-200 transition-all duration-300">
                      {/* Order Header */}
                      <div className="bg-storePrimary-50 px-6 py-5">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                          <div className="flex items-center space-x-4 mb-4 md:mb-0">
                            <div className="w-14 h-14 bg-storePrimary-500 rounded-xl flex items-center justify-center">
                      ...
                      <div className="px-6 pb-6">
                        <div className="bg-storePrimary-25 rounded-lg p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                              <div className="w-2 h-2 bg-storePrimary-400 rounded-full"></div>
