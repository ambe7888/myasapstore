...
import { Search, Filter, Grid, List, Star, Heart, Car, Zap, Settings, Award, Loader2 } from 'lucide-react';
              ...
              <div className="lg:w-3/4">
                ...
                {listingMode === 'infinite_scroll' && (
                  <div ref={sentinelRef} className="mt-12 flex items-center justify-center h-10">
                    {loadingMore && <Loader2 className="h-6 w-6 animate-spin text-red-600" />}
