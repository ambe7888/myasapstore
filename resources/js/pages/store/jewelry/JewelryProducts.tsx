...
import { Search, Filter, Grid, List, Star, Heart, Crown, Gem, Shield, Loader2 } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Page Header */}
        <div className="bg-yellow-50 relative store-page-header">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10 store-page-header">
            ...
            <div className="lg:w-3/4">
              ...
              {listingMode === 'infinite_scroll' && (
                <div ref={sentinelRef} className="mt-8 flex items-center justify-center h-10">
                  {loadingMore && <Loader2 className="h-6 w-6 animate-spin text-yellow-600" />}
                  {!hasMore && items.length > 0 && (
                    <span className="text-sm text-neutral-400">{t('Vous avez tout vu')}</span>
                  )}
                </div>
              )}
            </div>
