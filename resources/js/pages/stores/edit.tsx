      ...
      <div className="space-y-6">
        <Tabs defaultValue="info" className="w-full">
          <TabsList className="flex w-full overflow-x-auto justify-start gap-1 p-1 bg-muted rounded-lg scrollbar-none h-auto">
            <TabsTrigger value="info" className="shrink-0 text-xs sm:text-sm px-3 py-2 whitespace-nowrap">{t('Informations générales')}</TabsTrigger>
            <TabsTrigger value="theme" className="shrink-0 text-xs sm:text-sm px-3 py-2 whitespace-nowrap">{t('Thème de la boutique')}</TabsTrigger>
            {planPermissions?.pwa_business && (
              <TabsTrigger value="pwa" className="shrink-0 text-xs sm:text-sm px-3 py-2 whitespace-nowrap">{t('Paramètres PWA')}</TabsTrigger>
            )}
          </TabsList>
